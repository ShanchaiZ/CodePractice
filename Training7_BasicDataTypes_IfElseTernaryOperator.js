...
// Psuedocode: the price of hotdog is n * the unit price
// the result is multiplication of the n argument:
...
function saleHotdogs(n) {
    if (n < 5) console.log(n * 100);
    else if (n >= 5 && n < 10) console.log(n * 95);
    else console.log(n * 90);
}
...
console.log("-------------------------------------")
// Refactored and ternary operator used:

function saleHotdogsTern(n) {
    console.log (n * (n < 5 ? 100 : n < 10 ? 95 : 90));
}
