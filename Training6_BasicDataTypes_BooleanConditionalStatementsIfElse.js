...
// this test above was passing everything except null and undefined because if null or undefined are there, there is a value which is true BUT WE WANT FALSE VALUE.
// therefore we write null and undefined conditions to equal to false. please see below:

function trueOrFalse1(val) {
    if (val == false || val === null || val === undefined) return "false";
    else return "true";
}

// Refactored and other answers to this puzzle:
//answer using terninary operator:
function trueOrFalseTernary(val) {
